...
export const practices: Practice[] = [
  // —— Красный талисман ——
  {
    ...
    text: 'Красный талисман — подготовка к алхимии. Задача этапа: вернуть гармонию в существование, получить первый строительный материал и инструментарий. Каждый блок практик состоит из видео с обучением и текста. Перейти дальше можно только после экзамена.',
  },
  {
    id: 'rt-e1',
    stageId: 'red-talisman',
  ...
  // —— Белая пагода ——
  {
    ...
    duration: '15:40',
    access: 'locked',
    description: 'Задачи и методы второго этапа: три опоры и основной алхимический процесс.',
    text: 'Белая пагода открывается после сдачи экзамена красного талисмана. Здесь формируется основа: твердый эликсир, продвинутый массаж сосудов и тайцзи уровней Земля — Небо — Человек.',
  },
  {
    id: 'wp-e1',
    stageId: 'white-pagoda',
