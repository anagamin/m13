...
const spaces = [
  ...
  },
  {
    ...
    name: 'Человек',
    term: 'цзин',
    text: 'Граница между Небом и Землёй. Пространство усилий и перемен — опора и движущее начало алхимии.',
  },
  {
    key: 'heaven',
    name: 'Небо',
  ...
  <div class="landing">
    ...
    <section class="who">
      <div class="container who__grid">
        ...
        <div class="who__text">
          ...
          <h2 class="section-title">Носители устной алхимической традиции</h2>
          <p class="section-lead">
            Наш метод основан на устной передаче алхимической традиции древнего Китая. В основе —
            учение о восьми бессмертных: каждый представляет свой подход к практике.
          </p>
          <p>
    ...
    <section class="what">
      <div class="narrow">
        ...
        <p>
          «Дракон обнимает жемчужину», энергии, меридианы, дворцы мозга — всё это не стоит воспринимать
          буквально и строить из них описательную модель. Реальное понимание вырастает исключительно из
          практики и перестройки сознания. Это стоит иметь в виду, получая любую информацию о методе.
        </p>
      </div>
    </section>
    ...
    <section class="aim">
      <div class="container aim__inner">
        <div>
          ...
          <p class="section-lead">
            Даже декларируемая цель — бессмертие — лишь образ. В реальности цель алхимии лежит за гранью
    ...
    <section class="path-preview">
      <div class="container">
        ...
        <p class="section-lead">
          Это не виртуальные ранги, а конкретные состояния практикующего — от подготовки к алхимии до
    ...
    <section class="proofs" id="proofs">
      <div class="container">
        ...
        <h2 class="section-title">Живое знание. Живая передача.</h2>
        <p class="section-lead">
